...
app = Flask(__name__)
app.secret_key = "mood-game-final-v2"
...
.topbar { position: fixed; top: 15px; right: 15px; width: 320px; }
...
def index():
    ...
    # FINAL SCREEN FIX (your requested behavior preserved)
    if qid == "END":
